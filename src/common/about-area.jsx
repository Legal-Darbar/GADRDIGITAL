...
import about_img_2 from "../../public/assets/img/about/about2.png"
import about_img_3 from "../../public/assets/img/about/about1.jpg"
import about_img_4 from "../../public/assets/img/about/about3.png"
...
const about_content = {
    ...
    sub_title: "We Offer Inspiring Websites and Future Edge Mobile Apps", 
    des: <>cutting-edge digital solutions company specializing in the design and development of high-quality websites and mobile applications.!</>,

    about_list: [
        <>Cross Platform Apps.</>,
        <>High Speed Server.</>,
        <> Future Inspiring Design.</>,
    ],
    btn_text: "About Us",
