...
import img from "../../../../public/assets/img/service/svdashboard.png" 

const service_content = {
    title: "Explore Our Services",
    sub_title: <>More than 1,000 companies trust us</>,

    bg_img: "/assets/img/service/sv-bg.jpg",
    title_2: <>App Development <br /> Tools & Methods</>,
    des: <>Android Apps and Websites <br /> of your choice</>,
    btn_text: "Contact Us",
                        ...
                        <div key={i} className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay={item.delay}>
                            <div className="tp-service__item mb-30">
                                ...
                                <div className="tp-service__content">
                                    <h3 className="tp-service__title-sm tp-yellow-color"><Link href="tel:+1(902)9791041">{item.title}</Link></h3>
                     ...
                     <div className="col-xl-4 col-lg-4 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                        ...
                        style={{backgroundImage: `url(${bg_img})`}} >
                           <div className="tp-service__top-content">
                              ...
                              <p>{des}</p>
                              <Link className="tp-btn-orange tp-btn-hover alt-color-white" href="tel:+1(902)9791041">
                                 <span>{btn_text}</span>
                                 <b></b>
                              </Link>
                           </div>
