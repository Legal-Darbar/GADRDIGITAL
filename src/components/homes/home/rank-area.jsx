...
import img_1 from "../../../../public/assets/img/rank/flutter.png";
import img_2 from "../../../../public/assets/img/rank/reactjs.png";
import img_3 from "../../../../public/assets/img/rank/wordpress.png";
...
const rank_content = {
    sub_title: "Gadr Digital",
    title: <> Give Your<br /> Imagination  <br /> a Stunning Reality</>,
    btn_text: "Get Quote",
                        ...
                        <div className="tp-rank__wrapper p-relative">
                           ...
                           <div className="tp-rank__rank-card wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s">
                            ...
                            {rank_data.map((item, i)  => 
                                ...
                                <Link href="/contact">{item.domain} </Link> 
