...
import  hero_thumb_1 from "../../../../public/assets/img/hero/heronew1.png";  
import  thumb_1 from "../../../../public/assets/img/hero/hero-sm-3.png";  
import  thumb_2 from "../../../../public/assets/img/hero/heronew4.png";  
import  hero_thumb_2 from "../../../../public/assets/img/hero/heronew3.png";   
...
const hero_content = {
    ...
    hero_title: <><span className='tp_title'><span className='child' >The Leading Apps & Website</span></span> <br />
        <span><span className='child pt-30'>Development Agency</span></span> </>,
                            ...
                            <div className="col-xl-10">
                                <div className="tp-hero__content-box text-center z-index-3">
                                    <div className="tp-hero__title-box p-relative">
                                        <h2 className="tp-hero__hero-title m-0 tp-title-anim p-50">
                                            {hero_title}
                                        </h2>
