...
import logo_black from "../../../public/assets/img/logo/logomain.png";
import logo_white from "../../../public/assets/img/logo/logomain.png";
                     ...
                     <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-8 col-6">
                        <div className="header-bottom__right d-flex align-items-center justify-content-end">
                           ...
                           <div className="header-bottom__btn d-flex align-items-center">
                              <Link className={`${style_2 ? 'tp-btn-inner alt-color-orange' : 'tp-btn-white alt-color-black'} tp-btn-hover d-none d-md-inline-block`} href="tel:+1(902)9791041">
                              ...
                              <Link className={`${style_2 ? 'tp-btn-inner alt-color-orange' : 'tp-btn-white alt-color-black'} tp-btn-hover d-none d-md-inline-block`} href="/contact">
                                 <span className="white-text">Get Quote</span>
                                 <b></b>
                              </Link>
